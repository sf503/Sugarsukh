...
public class Burtgel extends JFrame {
    ...
    public Burtgel(){
        ...
        //oorchloh
        JButton bt2=new JButton("Өөрчлөх");
        bt2.setForeground(Color.blue);
        bt2.setLocation(600, 80);
        bt2.setSize(100, 40);
        con.add(bt2);
        
        //ustgah
        JButton bt3=new JButton("Устгах");
        bt3.setForeground(Color.blue);
        bt3.setLocation(600, 130);
        bt3.setSize(100, 40);
        con.add(bt3);
